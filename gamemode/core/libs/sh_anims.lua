...
ix.anim.citizen_male = {
	...
	pistol = {
		...
		[ACT_MP_RUN] = {ACT_RUN, ACT_HL2MP_RUN_REVOLVER},
		[ACT_LAND] = {ACT_RESET, ACT_RESET},
	...
	shotgun = {
		...
		[ACT_MP_RUN] = {ACT_RUN_RIFLE_RELAXED, ACT_HL2MP_RUN_SHOTGUN},
		[ACT_LAND] = {ACT_RESET, ACT_RESET},
...
ix.anim.metrocop = {
	...
	smg = {
		...
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_HL2MP_WALK_CROUCH_SMG1},
	...
	shotgun = {
		...
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_SMG1_LOW, ACT_COVER_SMG1_LOW},
		[ACT_MP_WALK] = {ACT_WALK_RIFLE, ACT_WALK_AIM_RIFLE},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_HL2MP_WALK_CROUCH_SHOTGUN},
		[ACT_MP_RUN] = {ACT_RUN_RIFLE, ACT_RUN_AIM_RIFLE},
		[ACT_LAND] = {ACT_RESET, ACT_RESET}
	},
	grenade = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE, ACT_HL2MP_IDLE_GRENADE},
		[ACT_MP_CROUCH_IDLE] = {ACT_COVER_PISTOL_LOW, ACT_HL2MP_IDLE_CROUCH_GRENADE},
		[ACT_MP_WALK] = {ACT_WALK, ACT_HL2MP_WALK_GRENADE},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_HL2MP_WALK_CROUCH_GRENADE},
		[ACT_MP_RUN] = {ACT_RUN, ACT_RUN},
		[ACT_LAND] = {ACT_RESET, ACT_RESET},
...
ix.anim.overwatch = {
	normal = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE_RELAXED, ACT_IDLE_ANGRY},
	...
	pistol = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE_RELAXED, ACT_IDLE_ANGRY_PISTOL},
		[ACT_MP_CROUCH_IDLE] = {ACT_CROUCHIDLE, ACT_COVER_PISTOL_LOW},
		[ACT_MP_WALK] = {ACT_WALK, ACT_WALK_AIM_PISTOL},
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH_RIFLE, ACT_HL2MP_WALK_CROUCH_REVOLVER},
		[ACT_MP_RUN] = {ACT_RUN_AIM_RIFLE, ACT_RUN_AIM_PISTOL},
		[ACT_LAND] = {ACT_RESET, ACT_RESET}
	},
	smg = {
		[ACT_MP_STAND_IDLE] = {ACT_IDLE_SMG1, ACT_IDLE_ANGRY_SMG1},
	...
	melee = {
		...
		[ACT_MP_CROUCHWALK] = {ACT_WALK_CROUCH, ACT_HL2MP_WALK_CROUCH_MELEE},
		[ACT_MP_RUN] = {ACT_RUN, ACT_RUN},
		[ACT_LAND] = {ACT_RUN_AIM_RIFLE, ACT_RUN_AIM_RIFLE},
		attack = ACT_MELEE_ATTACK_SWING_GESTURE
	},
	glide = ACT_GLIDE
}
