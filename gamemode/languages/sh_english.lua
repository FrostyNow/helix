...
LANGUAGE = {
	...
	maxAmmoReached = "You are carrying the maximum amount of this ammunition!",
	player = "Player",
	finish = "Finish",
	...
	cmdDoorReset = "Resets the door you are looking at to its initial state.",
	dReset = "The door has been reset to its initial state.",
	...
	unclip = "Unload Clip",
	unclipTip = "Removes the clip from the weapon.",
	...
	cmdCopyVendor = "Copies the vendor's settings.",
	vendorCopySuccess = "Vendor information copied successfully.",
	cmdPasteVendor = "Pastes the copied vendor settings to the targeted vendor.",
	vendorPasteSuccess = "Vendor information pasted successfully.",
	...
	mapChanging = "The map will change to %s in %d seconds!",
	...
	optShowBarLabels = "Show info bar labels",
	optdShowBarLabels = "Displays the name of each info bar in its center.",
	...
	cmdDoorSetOwner = "Sets or removes the owner of the door you are looking at. (Also works with offline character names)",
	dOwnerRemoved = "You have removed the owner of this door.",
	dOwnerSet = "You have set %s (online) as the owner of this door.",
	dOwnerSetOffline = "You have set the offline character (%s) as the owner of this door. They will receive it upon connection.",
	dNoMapCreationID = "This door does not have a valid map creation ID.",
	dNoSaverPlugin = "Could not find the Door Saver plugin.",
	dNoCharacterName = "Could not find a character with that name.",
	dCannotChangeName = "Server settings prevent changing the door's name.",
