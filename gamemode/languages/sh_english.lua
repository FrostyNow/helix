...
LANGUAGE = {
	...
	misc = "Miscellaneous",
	chatTransparency = "Chat Transparency",
	optdChatTransparency = "Whether or not to apply distance-based transparency to chat messages. Messages will fade up to 50%% opacity as distance increases.",
