...
function PLUGIN:PostDrawTranslucentRenderables(bDepth, bSkybox)
	...
	local bShowAreas = ix.option.Get("observerESP", true) and ix.option.Get("showAreas", false) and client:IsAdmin() and client:GetMoveType() == MOVETYPE_NOCLIP and !client:InVehicle()
